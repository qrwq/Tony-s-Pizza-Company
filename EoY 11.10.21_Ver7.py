...
def Order():
    ...
    new_window.geometry("620x650+300+10")
    ...
    phNumber = phNumberEntry.get().strip()
    ...
    #Creating unit price labels and formats them to 2 d.p
    if len(orderPrices) >=1:
        pizza_priceLabel=Label(new_window, text='$' + '{:.2f}'.format(orderPrices[0]), font="arial 12", bg="white").place(x=350, y=305)
    if len(orderPrices) >=2:
        pizza_priceLabel2=Label(new_window, text='$' + '{:.2f}'.format(orderPrices[1]), font="arial 12", bg="white").place(x=350, y=345)
    if len(orderPrices) >=3:
        pizza_priceLabel3=Label(new_window, text='$' + '{:.2f}'.format(orderPrices[2]), font="arial 12", bg="white").place(x=350, y=385)
    if len(orderPrices) >=4:
        pizza_priceLabel4=Label(new_window, text='$' + '{:.2f}'.format(orderPrices[3]), font="arial 12", bg="white").place(x=350, y=425)
    if len(orderPrices) >=5:
        pizza_priceLabel5=Label(new_window, text='$' + '{:.2f}'.format(orderPrices[4]), font="arial 12", bg="white").place(x=350, y=465)
    else:
        pass
    ...
    if len(order) >=1:
        pizza_amountLabel = Label(new_window, text='$' + '{:.2f}'.format(amount1), font="arial 12", bg="white").place(x=490, y=305)
    if len(order) >=2:
        pizza_amountLabel2 = Label(new_window, text='$' + '{:.2f}'.format(amount2), font="arial 12", bg="white").place(x=490, y=345)
    if len(order) >=3:
        pizza_amountLabel3 = Label(new_window, text='$' + '{:.2f}'.format(amount3), font="arial 12", bg="white").place(x=490, y=385)
    if len(order) >=4:
        pizza_amountLabel4 = Label(new_window, text='$' + '{:.2f}'.format(amount4), font="arial 12", bg="white").place(x=490, y=425)
    if len(order) >=5:
        pizza_amountLabel5 = Label(new_window, text='$' + '{:.2f}'.format(amount5), font="arial 12", bg="white").place(x=490, y=465)
...
max5_label = Label(root, text="(Max 5)", font="arial 12 bold", bg="white")
max5_label2 = Label(root, text="(Max 5)", font="arial 12 bold", bg="white")
